...
namespace WebApi.Negocio.Tests
{
    ...
    public class TestTranscripcionesService
    {
        ...
        {
            var bo = new TranscripcionesService();
            Mock<VocaliEntities> dbMock = ObtenerDBMock();
            bo.db = bo.dbPruebas = dbMock.Object;
            //bo.dbPruebas = dbMock.Object;
            bo.ficherosResource = new FicherosResourceMock();
        ...
        //[TestMethod]
        //public void InsertarTranscripcion_OK()
        //{
        //    var bo = new TranscripcionesService();
        //    //Mock<VocaliEntities> dbMock = ObtenerDBMock();
        //    //bo.db = bo.dbPruebas = dbMock.Object;
        ...
        //    Transcripcion transcripcion = new Transcripcion { Id = 33 };

        //    int numeroTranscripciones = bo.db.Transcripciones.Count();

        //    bo.InsertarTranscripcion(transcripcion);

        //    Assert.AreEqual(bo.db.Transcripciones.Count(), numeroTranscripciones+1);
        //}
